...
SHORTENER_URL = "gplinks.com" # অথবা আপনার পছন্দের শর্টনার
SHORTENER_API = "e07aec576df2a9ed36f1b94b8017cc53b792496f"
...
async def generate_claim_link(bot, query):
    ...
    text = (
        ...
        "লিংকটি ওপেন করে 'Continue' করুন। সফলভাবে ভেরিফাই হলে আপনার ৪ ঘণ্টার জন্য প্রিমিয়াম প্ল্যান এক্টিভেট হয়ে যাবে।"
    )
